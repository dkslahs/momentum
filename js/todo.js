...
todoForm.style.top = "210px";
todoForm.style.left = "1300px";

todoList.style.position = "absolute";
todoList.style.top = "210px";
todoList.style.left = "1300px";

todoList.style.fontSize = "20px"; // 크기 조정
todoList.style.color = "white"; // 텍스트 색상